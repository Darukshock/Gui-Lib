...
execute on passengers store result score #bool ui.val run data modify entity @s data.previous set from storage ui current

execute if score #bool ui.val matches 1 run function ui/minecart/on_change